...
var PersonalComponent = (function () {
    ...
    PersonalComponent.prototype.ngOnInit = function () {
        ...
        this.stateList = new forms_1.FormControl();
        this.work = new forms_1.FormControl();
        this.sal = new forms_1.FormControl();
        this.loanamt = new forms_1.FormControl();
    ...
    PersonalComponent.prototype.saveInfo = function (formValues) {
        ...
        this.formDataService.postQuoteInfo(formValues)
            ...
            _this.quoteData = JSON.parse(localStorage.getItem('getQuoteData'));
            _this.quoteId = _this.quoteData.quoteID;
            alert("Your Quote is :" + _this.quoteId);
